...
<div class="board-player-status">
	...
	<div class="turn-triangle" class:player1={currentTurn == 1} class:player2={currentTurn == 2}>
		<Triangle
			fill={currentTurn == 1 ? 'var(--red-player-fill)' : 'var(--blue-player-fill)'}
			stroke={currentTurn == 1 ? 'var(--red-player-border)' : 'var(--blue-player-border)'}
		/>
	</div>
